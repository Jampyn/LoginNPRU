...
WebUI.setText(findTestObject('Object Repository/Page_Register/input__school_years'), '2565')

WebUI.setText(findTestObject('Object Repository/Page_Register/input__groups'), '63/50')

WebUI.setText(findTestObject('Object Repository/Page_Register/input__days'), '14')

WebUI.setText(findTestObject('Object Repository/Page_Register/input__months'), 'มีนาคม')
...
WebUI.verifyTextPresent('The emai field is required.', false)

WebUI.click(findTestObject('Object Repository/Page_Register/div_'))
